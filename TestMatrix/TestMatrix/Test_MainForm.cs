...
//             comboBox_test1_heartbeatAuxPort.Text = "COM1";
        ...
        private void button_startTest_Click(object sender, EventArgs e)
        {
            ...
            if (canRun)
            {
                ...
                try { config.GoodRead_TCPClient_hostPort = ToInt32(textBox_test1_goodreadTcpClientPort.Text); }
                catch { config.GoodRead_TCPClient_hostPort = 0; }
                try { config.GoodRead_TCPServer_hostPort = ToInt32(textBox_test1_goodreadTcpServerPort.Text); }
                catch { config.GoodRead_TCPServer_hostPort = 0; }
                try { config.GoodRead_UDPServer_hostPort = ToInt32(textBox_test1_goodreadUdpServerPort.Text); }
                ...
                try { config.NoRead_TCPClient_hostPort = ToInt32(textBox_test1_noreadTcpClientPort.Text); }
                catch { config.NoRead_TCPClient_hostPort = 0; }
                try { config.NoRead_TCPServer_hostPort = ToInt32(textBox_test1_noreadTcpServerPort.Text); }
                catch { config.NoRead_TCPServer_hostPort = 0; }
                try { config.NoRead_UDPServer_hostPort = ToInt32(textBox_test1_noreadUdpServerPort.Text); }
                ...
                try { config.PartialRead_TCPClient_hostPort = ToInt32(textBox_test1_partialreadTcpClientPort.Text); }
                catch { config.PartialRead_TCPClient_hostPort = 0; }
                try { config.PartialRead_TCPServer_hostPort = ToInt32(textBox_test1_partialreadTcpServerPort.Text); }
                catch { config.PartialRead_TCPServer_hostPort = 0; }
                try { config.PartialRead_UDPServer_hostPort = ToInt32(textBox_test1_partialreadUdpServerPort.Text); }
                ...
                try { config.MultipleRead_TCPClient_hostPort = ToInt32(textBox_test1_multiplereadTcpClientPort.Text); }
                catch { config.MultipleRead_TCPClient_hostPort = 0; }
                try { config.MultipleRead_TCPServer_hostPort = ToInt32(textBox_test1_multiplereadTcpServerPort.Text); }
                catch { config.MultipleRead_TCPServer_hostPort = 0; }
                try { config.MultipleRead_UDPServer_hostPort = ToInt32(textBox_test1_multiplereadUdpServerPort.Text); }
                ...
                try { config.HeartBeat_TCPClient_hostPort = ToInt32(textBox_test1_heartbeatTcpClientPort.Text); }
                catch { config.HeartBeat_TCPClient_hostPort = 0; }
                try { config.HeartBeat_TCPServer_hostPort = ToInt32(textBox_test1_heartbeatTcpServerPort.Text); }
                catch { config.HeartBeat_TCPServer_hostPort = 0; }
                try { config.HeartBeat_UDPServer_hostPort = ToInt32(textBox_test1_heartbeatUdpServerPort.Text); }
                catch { config.HeartBeat_UDPServer_hostPort = 0; }
